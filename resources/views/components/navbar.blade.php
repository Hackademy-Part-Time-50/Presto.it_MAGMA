                    ...
                    <ul class="dropdown-menu futuristic-menu">
                        @foreach ($categories as $category)
                            <li><a href="{{ route('byCategory', ['category' => $category]) }}"
                                    class="dropdown-item text-capitalize">{{ $category->name }}</a></li>
                            @if (!$loop->last)
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="navbar-nav">
                ...
                <div class=" ">
                    ...
                    <form action="{{ route('article.search') }}" class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3"
                ...
                @auth
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end futuristic-menu">
                            ...
                            @if (Auth::user()->is_revisor)
                                <li class="nav-item">
                                    <a class="nav-link btn btn-sm position-relative w-sm-25"
                                        href="{{ route('revisor.index') }}">Zona Revisore
                                        <span
